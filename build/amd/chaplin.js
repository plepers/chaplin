...
define('chaplin/dispatcher',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/utils', 'chaplin/lib/event_broker', 'chaplin/controllers/composite', 'chaplin/models/dom_model'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
"use strict";

var Backbone, ComponentsLoader, CompositeController, Dispatcher, DomModel, EventBroker, utils, _, __bind = function(fn, me) {
    return function() {
...
define('chaplin/controllers/composite',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/event_broker', 'chaplin/controllers/controller'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
"use strict";

var Backbone, CompositeController, Controller, EventBroker, _, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
...
module.exports = CompositeController = function(_super) {
    ...
    CompositeController.prototype.executeBeforeActions = function(controller, route, params, options) {
        var action, actions, beforeActions, name, next, _i, _len, _ref, _this = this;
        beforeActions = [];
...
define('chaplin/controllers/root',['require', 'exports', 'module', 'chaplin/controllers/controller', 'chaplin/views/view'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin/models/html_model_parser',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/models/model', 'chaplin/models/collection'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
var Backbone, Collection, DATA_ID_ATTR, DATA_LIST_ATTR, DATA_SELECTOR_ATTR, HtmlModelParser, LinkModel, Model, ModelContext, NodeModel, hasTemplate, mdl_set_options, modelFactory, modelsTemplates, tagNameSelector, _, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
define('chaplin/models/dom_model',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/models/model', 'chaplin/lib/event_broker', 'chaplin/controllers/root', 'chaplin/models/html_model_parser', 'jquery', 'chaplin/lib/batcher'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin/lib/history',['require', 'exports', 'module', 'chaplin/lib/event_broker', 'backbone', 'underscore'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin/lib/router',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/event_broker', 'chaplin/lib/route', 'chaplin/lib/history', 'chaplin/lib/utils', 'chaplin'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
"use strict";

var Backbone, Chaplin, EventBroker, History, Route, Router, utils, _, __bind = function(fn, me) {
    return function() {
        return fn.apply(me, arguments);
    };
};
...
define('chaplin/lib/batcher',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/sync_machine'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
"use strict";

var Backbone, Batcher, LoadableClass, SyncMachine, _, __bind = function(fn, me) {
    return function() {
        return fn.apply(me, arguments);
    };
};
...
define('chaplin/tree/node',['require', 'exports', 'module', 'backbone', 'underscore'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin/tree/path',['require', 'exports', 'module', 'chaplin/tree/sitetree'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin/tree/sitetree',['require', 'exports', 'module', 'chaplin/tree/node'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
var Node, SiteTree, instance, __bind = function(fn, me) {
    return function() {
        return fn.apply(me, arguments);
    };
};
...
define('chaplin',['require', 'exports', 'module', 'chaplin/application', 'chaplin/mediator', 'chaplin/dispatcher', 'chaplin/controllers/controller', 'chaplin/controllers/composite', 'chaplin/controllers/root', 'chaplin/composer', 'chaplin/lib/composition', 'chaplin/models/collection', 'chaplin/models/model', 'chaplin/models/html_model_parser', 'chaplin/models/dom_model', 'chaplin/views/layout', 'chaplin/views/view', 'chaplin/views/collection_view', 'chaplin/lib/history', 'chaplin/lib/route', 'chaplin/lib/router', 'chaplin/lib/delayer', 'chaplin/lib/event_broker', 'chaplin/lib/helpers', 'chaplin/lib/support', 'chaplin/lib/sync_machine', 'chaplin/lib/batcher', 'chaplin/lib/utils', 'chaplin/tree/node', 'chaplin/tree/path', 'chaplin/tree/sitetree'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
